...
-- Includes
dofile( "../bakefiles/wxpresets.lua" )

-- Configure a C/C++ package to use wxWidgets
function MakeWxAdditionsPackage( package, altTargetName, wxVer, wxVerMinor )
	...
	ConfigureWxWidgets( package, targetName, wx_ver, wx_ver_minor )
end
