...
%MAKE% -f %MAKEFILE% clean BUILD=debug SHARED=0 OFFICIAL_BUILD=1 RUNTIME_LIBS=static %FLAGS%
...
:: Calling the compilers  make
%MAKE% -f %MAKEFILE% clean BUILD=release SHARED=0 OFFICIAL_BUILD=1 RUNTIME_LIBS=static %FLAGS%
...
:: Calling the compilers  make
%MAKE% -f %MAKEFILE% clean BUILD=debug UNICODE=1 OFFICIAL_BUILD=1 RUNTIME_LIBS=static %FLAGS%
...
:: Calling the compilers  make
%MAKE% -f %MAKEFILE% clean BUILD=release UNICODE=1 OFFICIAL_BUILD=1 RUNTIME_LIBS=static %FLAGS%
